    ...
    var rtsJs = {
        ...
        cartNumberIncDec: function(){
          $(document).ready(function(){
            ...
            $(function(){
                ...
                $(".input-container").on("click", function changeNumber(e) {
                    if(e.target == minus) {
                        input.value--;
        ...
        modalpopupCard: function(){
            // Newsletter popup
              ...
              $(".banks-details-popup-btn").on('click', function () {
                $(".banks-details-popup-wrapper").addClass("popup")
                $("#anywhere-home").addClass("bgshow");
              });
              $(".banks-bottom-action .view-btn").on('click', function () {
                $(".banks-details-popup-wrapper").addClass("popup");
                $("#anywhere-home").addClass("bgshow");
              });
              $(".banks-details-popup-wrapper .cart-edit").on('click', function () {
                $(".banks-details-popup-wrapper").addClass("popup");
                $("#anywhere-home").addClass("bgshow");
              });

              $(".banks-details-close-btn").on('click', function () {
                $(".banks-details-popup-wrapper").removeClass("popup");
                $("#anywhere-home").removeClass("bgshow");
              });
