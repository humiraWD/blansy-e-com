        ...
        <div class="table-responsive text-nowrap">
            <table class="table table-dark">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        <td class="rounded-start-bottom"><i class="bx bxl-bootstrap bx-sm text-primary me-3"></i> <span
            ...
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    <tr class="table-default">
                        <td><i class="bx bxl-sketch bx-sm text-warning me-3"></i> <span class="fw-medium">Sketch
                                Project</span></td>
                        <td>Ronnie Shane</td>
                        <td>
                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                    ...
                    <tr class="table-info">
                        <td><i class="bx bxl-bootstrap bx-sm text-primary me-3"></i> <span class="fw-medium">Latest
                                Bootstrap</span></td>
                        <td>Perry Parker</td>
                        <td>
                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                    ...
                    <tr class="table-dark">
                        <td class="rounded-start-bottom"><i class="bx bxl-bootstrap bx-sm text-primary me-3"></i> <span
                                class="fw-medium">Bootstrap UI</span></td>
                        <td>Jerry Milton</td>
                        <td>
                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
